...
public class Test {
    ...
    //Usuarios
    private static String[][] usuarios = {{"0106228414", "ABAD CONTRERAS", "DAVID LEONARDO"},
    ...
    private static TipoUsuario[] tipoUsuario = {TipoUsuario.DOCENTE, TipoUsuario.EMPLEADO, TipoUsuario.ESTUDIANTE};
